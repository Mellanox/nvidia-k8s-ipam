...
func (in *CIDRPoolSpec) DeepCopyInto(out *CIDRPoolSpec) {
	*out = *in
	...
	if in.PerNodeExclusions != nil {
		in, out := &in.PerNodeExclusions, &out.PerNodeExclusions
		*out = make([]ExcludeIndexRange, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExcludeIndexRange) DeepCopyInto(out *ExcludeIndexRange) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExcludeIndexRange.
func (in *ExcludeIndexRange) DeepCopy() *ExcludeIndexRange {
	if in == nil {
		return nil
	}
	out := new(ExcludeIndexRange)
	in.DeepCopyInto(out)
	return out
}
