...
var _ = Describe("plugin tests", func() {
	...
	Context("CmdAdd()", func() {
		It("executes successfully", func() {
			...
			mockDaemonClient.On("Allocate", mock.Anything, &daemonv1.AllocateRequest{
				Parameters: &daemonv1.IPAMParameters{
					Pools:          []string{"my-pool"},
					CniIfname:      "net1",
					CniContainerid: "1234",
				...
				}}).Return(&daemonv1.AllocateResponse{
				Allocations: []*daemonv1.AllocationInfo{{
					Pool:    "my-pool",
					Ip:      "192.168.1.10/24",
					Gateway: "192.168.1.1",
				}},
