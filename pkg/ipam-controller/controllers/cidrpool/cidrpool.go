...
// isPrefixFullyExcluded checks if the providedprefix is fully excluded by CIDRPool various exclusions.
func (r *CIDRPoolReconciler) isPrefixFullyExcluded(prefix string, pool *ipamv1alpha1.CIDRPool) bool {
	...
	firstIP, ipn, _ := net.ParseCIDR(prefix)
	...
	// merged list contains exacly one element.
