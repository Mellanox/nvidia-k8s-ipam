...
func New() *Options {
	return &Options{
		...
		CNIDaemonCallTimeout: 5,
		CNIConfDir:           cniTypes.DefaultConfDir,
		CNILogLevel:          cniTypes.DefaultLogFile,
		CNILogFile:           cniTypes.DefaultLogLevel,
	}
}
...
func (o *Options) AddNamedFlagSets(sharedFS *cliflag.NamedFlagSets) {
	...
	cniFS.IntVar(&o.CNIDaemonCallTimeout, "cni-daemon-call-timeout", o.CNIDaemonCallTimeout,
...
func (o *Options) Validate() error {
	...
	if err := o.verifyFileExists(); err != nil {
		return err
	}
